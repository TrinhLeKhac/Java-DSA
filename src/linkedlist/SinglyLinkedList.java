...
//        sll.display();
        ...
        sll.display();
        System.out.println("The " + n + "nth element from the end of linkedlist.SinglyLinkedList: " + nthNodeFromTheEnd.data);
        System.out.println('\n');

        System.out.println("------------------searchKey---------------------");
        int searchKey = 1;
        if (sll.find(searchKey)) {
            System.out.println("Found element " + searchKey + " in linkedlist.SinglyLinkedList");
        } else {
            System.out.println("Element " + searchKey + " not found in linkedlist.SinglyLinkedList");
        }
        System.out.println('\n');
        ...
        System.out.print("First linkedlist.SinglyLinkedList: ");
        sll_a.display();
        System.out.print("Second linkedlist.SinglyLinkedList: ");
        sll_b.display();

        Node mergedHead = merge(sll_a.head, sll_b.head);
        SinglyLinkedList sll_merged = new SinglyLinkedList(mergedHead);
        System.out.print("Merged linkedlist.SinglyLinkedList: ");
        sll_merged.display();
        ...
        System.out.print("First linkedlist.SinglyLinkedList: ");System.out.print("First linkedlist.SinglyLinkedList: ");
        sll_c.display();
        ...
        System.out.print("Added linkedlist.SinglyLinkedList: ");
        sll_added.display();
